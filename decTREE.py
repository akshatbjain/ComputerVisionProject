...
#     # for x in range(int(cent[0][0]-50),int(cent[0][0]+50)):
#     # 	for y in range(int(cent[0][1]-50),int(cent[0][1]+50)):
#     # 		if (frame3[x,y,0]<50) and (frame3[x,y,1]>200) and (frame3[x,y,2]<50) :
#     # 			green=green+1
#     # 			print green
#     # 			cent=cent[x,y]
